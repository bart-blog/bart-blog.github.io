...
(function () {
  ...
  // ---------------------------------------------------------------- colour (pink and blue, like her four: 🩷💙💙🩷)
  const hex = (h) => [parseInt(h.slice(1, 3), 16), parseInt(h.slice(3, 5), 16), parseInt(h.slice(5, 7), 16)];
  BJ.C = {
    white: hex('#ffffff'), bg: hex('#fff7f3'), ink: hex('#2a1b24'), coral: hex('#ff5a4f'), pink: hex('#f58fb3'),
    rose: hex('#e2477f'), blue: hex('#4d8df6'), baby: hex('#b9d6ff'), navy: hex('#23305a'), slate: hex('#7b89b6'),
    sand: hex('#f1ddcc'), blush: hex('#fbe1e9'), nn: hex('#ff6a13'), gold: hex('#f7b733'), amber: hex('#e58e10'), steel: hex('#b3bdd6'),
  };
