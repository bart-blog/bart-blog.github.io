...
(function () {
  ...
  // ---------------------------------------------------------------- colour (Full Circle IT palette)
  const hex = (h) => [parseInt(h.slice(1, 3), 16), parseInt(h.slice(3, 5), 16), parseInt(h.slice(5, 7), 16)];
  BJ.C = {
    white: hex('#f8fafc'), bg: hex('#050d1a'), mid: hex('#0a1628'), card: hex('#0f2040'),
    azure: hex('#0078d4'), bright: hex('#2563eb'), teal: hex('#06b6d4'), glow: hex('#60a5fa'), violet: hex('#8b5cf6'),
    orange: hex('#f97316'), amber: hex('#fb923c'), steel: hex('#94a3b8'), silver: hex('#cbd5e1'), slate: hex('#334155'),
    dim: hex('#1c2d4a'), tdim: hex('#132440'), deep: hex('#0a3566'),
  };
